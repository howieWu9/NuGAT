...
class AttentionTransportCostNetwork(nn.Module):
    """Attention Transport cost network for evidence-anchor correspondence learning."""
    def __init__(
        self,
...
def sinkhorn_plan(
    ...
    if gamma <= 0:
        raise ValueError("gamma must be positive for the transport plan")
